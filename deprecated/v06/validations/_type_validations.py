...
from deprecated.v06 import messages
...
def validate_all_type_card(sequence: Iterable):
    ...
    from deprecated.v06.structures._card import Card
...
def validate_all_type_player(sequence: Iterable):
    ...
    from deprecated.v06.structures._player import Player
...
def validate_type_action(obj):
    ...
    from deprecated.v06.structures._action import Action
...
def validate_type_hand(obj):
    ...
    from deprecated.v06.structures._hand._hand import Hand
...
def validate_type_table(obj):
    ...
    from deprecated.v06.structures._table import Table
