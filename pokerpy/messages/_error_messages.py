...
table_not_int_smallest_raise_amount_message = "Table smallest raise amount increase must be int, not '{}'."
...
table_sra_not_multiple_of_smallest_chip_message = "Table smallest raise amount cannot be zero and must be a multiple of the smallest chip: {} (received {})."
