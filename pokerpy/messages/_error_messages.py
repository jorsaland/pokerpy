...
player_not_smallest_chip_multiple_increase_message = "Player amount increase must be a multiple of the smallest chip: {} (received {})."
player_smallest_chip_not_more_than_zero_message = "Smallest chip must be more than zero (received {})."
...
table_not_smallest_chip_multiple_increase_message = "Table amount increase must be a multiple of the smallest chip: {} (received {})."
